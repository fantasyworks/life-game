...
class KeyboardUtil {
     ...
     * @returns {boolean}
     */
    static isFocusByCaretPosition(input, keyCode) {
        let position = KeyboardUtil.getCaretPosition(input);
        let result = true;
        switch (keyCode) {
...
exports.KeyboardUtil = KeyboardUtil;
/**
 * Keyのコード
 */
var KeyCode;
...
//# sourceMappingURL=keybord.util.js.map